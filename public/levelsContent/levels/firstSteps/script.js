...
const addPattern = async pKey => {
    if (pKey === 0) await patterns.pInverseBarrage(Utils.mathRandom(2, 3), 300, 300);
    ...
    else if (pKey === 3) await patterns.pRandomBarrage(Utils.mathRandom(3, 4), 300, 300);
    else if (pKey === 4) await patterns.pTunnel(Utils.mathRandom(2, 3), 500, 600);
}
...
level.onInit = () => {
    ...
    level.setWallSpeedIncrement(0.15);
