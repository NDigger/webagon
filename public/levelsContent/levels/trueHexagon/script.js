...
level.onInit = () => {
    ...
    const bgTileColors = level.getBackgroundTileColors();
    backgroundFirstColorLerp.value = bgTileColors[0];
    backgroundSecondColorLerp.value = bgTileColors[1];

    level.setMainColor(Color.hsvToRgb(.4, 1, .5))
...
level.onUpdate = ft => {
    ...
    console.log(backgroundFirstColorLerp.value,
